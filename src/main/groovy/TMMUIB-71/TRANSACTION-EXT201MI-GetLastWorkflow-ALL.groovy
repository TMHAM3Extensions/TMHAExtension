 ...
 *Name        EXT201MI.GetLastWorkflow
 *Type        Transaction
 *Description Retrieve the last Audit Trail where ACTA = Sent for approval
 *
...
/**
* - Retrieve the last Audit Trail where ACTA = Sent for approval
*/
public class GetLastWorkflow extends ExtendM3Transaction {
 ...
 */
  public GetLastWorkflow(MIAPI mi, DatabaseAPI database, MICallerAPI miCaller, LoggerAPI logger, ProgramAPI program, IonAPI ion) {
    this.mi = mi;
  ...
  public void main() {
    ...
    DBAction queryEXT201 = database.table("EXT201").index("10").selection("EXCONO", "EXPUNO", "EXPLPN", "EXPLPS", "EXPLP2", "EXACTA", "EXRESP", "EXTMST").build();
    ...
    dbEXT201.set("EXACTA", "Sent for approval");
    int noOfRecords = 0;
    noOfRecords = queryEXT201.readAll(dbEXT201, 7, 100, listEXT201);
    if (noOfRecords == 0) {
